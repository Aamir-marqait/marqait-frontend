      ...
      <div className="w-full lg:w-3/5 flex items-center justify-start pl-20 pr-8 py-8 bg-white">
        <div className="w-full max-w-lg">
            ...
            <div className="w-[640px] flex justify-center">
              <button
                ...
                style={{
                  ...
                  borderImage: isLoading || !agreeToTerms || !email || !password
          ...
          <div className="w-[640px] mx-auto my-6 flex items-center">
            ...
            <span className="px-4 text-[14px] font-normal leading-[130%] tracking-[-0.05em] text-center text-[#444444] font-inter">OR</span>
            <div className="flex-1 border-t border-[#EEEEEE]"></div>
          </div>
          ...
          {/* Sign Up Link */}
          <div className="w-[640px] mx-auto mt-8 flex justify-center">
